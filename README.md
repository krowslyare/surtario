...
**Current iteration after PR #36:** contextual inquiry/research entry, one continuity hub, direct purchase calculation and a product landing with accessible walkthrough. Live English discovery retains up to 30 candidate sources, publishes progress through Convex, and automatically analyzes up to three product pages. Branded, reviewed quotation emails and replies complete the local sourcing journey. See [dated local evidence and remaining acceptance](docs/desarrollo/ETAPAS.md#september-19-2026--contextual-funnel-and-recovery). The [previous decision-flow contract](docs/desarrollo/CONSOLIDACION_DECISION.md) remains in force. Older test counts below belong to their dated deliveries. No cloud publication is included in this iteration.
