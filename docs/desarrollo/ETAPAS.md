...
| 2 | Viabilidad de integraciones externas | En curso | Convex cloud dev configured; real Firecrawl discovery and AgentMail round trip/replay passed; broader Firecrawl validation found unreadable, irrelevant and ambiguous sources. Direct OpenAI API acceptance remains pending; local Luna CLI rehearsal passed with simulated web/mail, as documented below |
