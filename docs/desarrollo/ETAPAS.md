...
| 2 | Viabilidad de integraciones externas | En curso | Convex cloud dev configured; real Firecrawl discovery returned three sources and AgentMail round trip/replay passed. Direct OpenAI API acceptance remains pending; local Luna CLI rehearsal passed with simulated web/mail, as documented below |
