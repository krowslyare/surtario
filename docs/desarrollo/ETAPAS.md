...
PR 8 local review: Integrated reviewed main into synthetic image/PDF extraction. Sol review and parent adjudication found no material issue; the PNG preview represents the same PDF content, verified against the fixture. Human review and server-owned file limits remain enforced. 85 tests/build and 2 focused browser checks passed. Real provider verification and deployment remain pending.
