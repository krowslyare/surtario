...
- Los nombres y especificaciones deben seguir siendo los del ejemplo. Al actualizar, la identidad se valida contra la evidencia ya guardada y las ofertas se limitan al conjunto original. Las [revisiones de fuentes web guardadas](./REVISION_WEB_GUARDADA.md) tienen un contrato adicional de creación. Ofertas manuales nuevas y archivos propios siguen transitorios; no se habilita almacenamiento anónimo de textos privados.
